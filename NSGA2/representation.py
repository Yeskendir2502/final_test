...
def decode_chromosome(chromosome: Chromosome) -> Dict[str, list]:
    """
    Convert a chromosome (indexes) into a config dict with values
...
def mutate_chromosome(
    ...
    """
    Simple mutation: for each gene, with probability mutation_prob,
    change it to a *different* valid option index.
    """
